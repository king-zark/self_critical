...
from .CaptionModel_multi import CaptionModel
...
class AttModel(CaptionModel):
    ...
    def _forward(self, fc_feats, att_feats, seq, att_masks=None):
        ...
        for i in range(seq.size(1) - 1):
            ...
            output, output2, state, pre_att_res_1, pre_att_res_2 = self.get_logprobs_state(it, p_fc_feats, p_att_feats, pp_att_feats, p_att_masks, state, pre_att_res_1, pre_att_res_2)
            outputs[:, i] = output
            outputs2[:, i] = output2

        return (outputs, outputs2)

    def get_logprobs_state(self, it, fc_feats, att_feats, p_att_feats, att_masks, state, pre_att_res_1=None, pre_att_res_2=None):
    ...
    def _sample_beam(self, fc_feats, att_feats, att_masks=None, opt={}):
        ...
        for k in range(batch_size):
            ...
            for t in range(1):
                ...
                logprobs, logprobs2, state, pre_att_res_1, pre_att_res_2 = self.get_logprobs_state(it, tmp_fc_feats, tmp_att_feats, tmp_p_att_feats, tmp_att_masks, state, pre_att_res_1, pre_att_res_2)
            logprobs = logprobs + 0*logprobs2            
            self.done_beams[k] = self.beam_search(state, logprobs, pre_att_res_1, pre_att_res_2 , tmp_fc_feats, tmp_att_feats, tmp_p_att_feats, tmp_att_masks, opt=opt)
